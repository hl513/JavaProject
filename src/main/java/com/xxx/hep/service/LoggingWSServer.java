...
import com.xxx.hep.config.MyEndpointConfigure;
    ...
    public void onOpen(Session session) {
        ...
        new Thread(() -> {
            ...
            while (sessionMap.get(session.getId()) != null) {
                ...
                try {
                    //日志文件路径，获取最新的
                    String filePath = System.getProperty("user.home") + "/Desktop/log/" + new SimpleDateFormat("yyyyMMdd").format(new Date()) + "/"+applicationName+".log";
